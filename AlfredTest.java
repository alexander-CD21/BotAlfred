public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String testGuestGreetings = alfredBot.guestGreeting("Beth Kane","noches");
        ...
        String respuestaBot=alfredBot.respuestaEnfadada("Fastidioso");
        ...
        // Quita los comentarios uno a la vez a medida que implementas cada método.
         ...
         System.out.println(respuestaBot);
    }
}